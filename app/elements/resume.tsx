        ...
        <div className="px-4 py-5 sm:px-6">
          ...
          <div className="flex mt-2">
            <div className="mr-4">
              ...
              <a
                href="mailto:anujkarki553@gmail.com"
                className="ml-2 text-lg text-gray-900"
              >
                anujkarki553@gmail.com
              </a>
            </div>
            <div className="mr-4">
              <span className="text-lg text-gray-500">
            ...
            <div className="mr-4">
              ...
              <a href="#" className="ml-2 text-lg text-gray-900">
        ...
        <div className="border-t border-gray-200">
          <div className="bg-white px-4 py-5 sm:px-6">
            ...
            <div className="flex flex-wrap">
              ...
              xompany. I can be relied upon to help your company achieve its
              goal.
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">
              ...
              <div className="mt-2">
                ...
                <span className="text-sm italic">Apr 2022 - Present</span>
              </div>
            ...
            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">
              ...
              <div className="mt-2">
                ...
                , <span className="text-sm italic">March 2022 - Apr 2022</span>
              </div>
              <ul className="list-disc list-inside text-sm ">
          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">
              <div>
                ...
                <span className="text-sm italic">Lainchaur, Kathmandu</span>
                <div className="text-sm italic text-gray-600">
                  04/2023 - Present
                </div>
              </div>
            ...
            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">
              <div>
                ...
                <span>Nepal Commerce Campus</span>,{" "}
                <span className="text-sm italic">Minbhawan, Kathmandu</span>
                <div className="text-sm italic text-gray-600">
                  10/2017 - 07/2022
                </div>
              </div>
            ...
            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">
              <div>
                ...
                <span>GoldenGate Int'l School</span>,{" "}
                <span className="text-sm italic">Old Baneshwor, Kathmandu</span>
                <div className="text-sm italic text-gray-600">
                  08/2015 - 08/2017
                </div>
              </div>
